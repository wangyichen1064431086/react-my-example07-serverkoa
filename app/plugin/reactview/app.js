const util = require('util');//Node原生模块之一：实用工具 待研究！
const assert = require('assert');//Node原生模块之一：断言  待研究
...
module.exports = function(app) {
  ...
  assert(
    opts && opts.viewpath && util.isString(opts.viewpath), 
    '[reactview] viewpath is required, please check config!'
  );
